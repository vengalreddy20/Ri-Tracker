...
const url = `https://api.clockify.me/api/v1/workspaces/6192513371e028522c62bc50/projects`
function Project() {
          ...
          <TableBody>
            {data.map((row) => (
              <StyledTableRow key={row.id}>
                ...
                <StyledTableCell align="left">{row.public}</StyledTableCell>
